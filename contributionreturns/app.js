let model = "ContributionCalculator"

function loadDefaults(upgrade = false) {
    var currentTime = new Date()
    payload = {
        'Optimistic Scenario': { Principle: '$ 100', Goal: '$ 2,000', Rate: '7', Years: '30', Contribution: '$ 25' },
        'Pessimistic Scenario': { Principle: '$ 200', Goal: '$ 2,000', Rate: '4', Years: '30', Contribution: '$ 25' },
        app_url: 'https://asalimian.github.io/contributionreturns/app.html',
